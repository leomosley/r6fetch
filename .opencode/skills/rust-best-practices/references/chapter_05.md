...
## 5.2 Unit Test vs Integration Tests

As a general rule, without delving into _test pyramid naming_, rust has two sets of tests you own directly:
...
## 5.4 Snapshot Testing with `cargo insta`
